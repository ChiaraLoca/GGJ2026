...
public class MotionCreator
{
    public static Motion get5A()
    {
        ...
        return new Motion("punch",inputs, flippedInputs, 60, 20, 40, 0, 10, 5, 5, 12);
    }
    ...
    public static Motion get6A() {
        ...
        return new Motion("kick", inputs, flippedInputs, 100, 50, 60, 0, 30, 20, 3);
    }
    ...
    public static Motion get2A()
    {
        ...
        return new Motion("lowHit",inputs, flippedInputs, 60, 20, 40, 0, 5, 5, 3, 5, 12);
    }
}
