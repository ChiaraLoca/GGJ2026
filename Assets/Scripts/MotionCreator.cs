...
public class MotionCreator
{
    public static Motion get5A()
    {
        ...
        return new Motion("punch",inputs, flippedInputs, 18, 10, 12, 0, 5, 5, 3, false, 1f, 5, 12);
    }
    ...
    public static Motion get6A() {
        ...
        return new Motion("kick", inputs, flippedInputs, 36, 18, 20, 0, 15, 20, 3, true, 2f);
    }
    ...
    public static Motion get2A()
    {
        ...
        return new Motion("lowHit",inputs, flippedInputs, 20, 12, 14, 0, 5, 5, 3, true, 1f, 5, 12);
    }
}
